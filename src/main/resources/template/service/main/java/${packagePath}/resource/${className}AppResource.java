...
@Path(${className}AppResource.MODULE_NAME)
public class ${className}AppResource extends AppBaseResource{

    public static final String MODULE_NAME = BASE_URI_APP + "/${classname}";
